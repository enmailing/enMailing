...
import com.enmailing.k9.activity.UpgradeDatabases;
...
import com.enmailing.k9.mail.internet.BinaryTempFileBody;
import com.enmailing.k9.mail.store.LocalStore;
import com.enmailing.k9.provider.UnreadWidgetProvider;
import com.enmailing.k9.security.LocalKeyStore;
import com.enmailing.k9.service.BootReceiver;
import com.enmailing.k9.service.MailService;
import com.enmailing.k9.service.ShutdownReceiver;
import com.enmailing.k9.service.StorageGoneReceiver;
...
public class K9 extends Application {
	...
	private static String mEnMailingUsername = "";
	private static String mEnMailingAuthKey = "";
	private static String mEnMailingDeviceDesc = "";
	private static boolean mEnMailingNotifyOnly = false;
    ...
    public static class Intents {
        ...
        public static class EmailReceived {
            public static final String ACTION_EMAIL_RECEIVED    = "com.enmailing.k9.intent.action.EMAIL_RECEIVED";
            public static final String ACTION_EMAIL_DELETED     = "com.enmailing.k9.intent.action.EMAIL_DELETED";
            public static final String ACTION_REFRESH_OBSERVER  = "com.enmailing.k9.intent.action.REFRESH_OBSERVER";
            public static final String EXTRA_ACCOUNT            = "com.enmailing.k9.intent.extra.ACCOUNT";
            public static final String EXTRA_FOLDER             = "com.enmailing.k9.intent.extra.FOLDER";
            public static final String EXTRA_SENT_DATE          = "com.enmailing.k9.intent.extra.SENT_DATE";
            public static final String EXTRA_FROM               = "com.enmailing.k9.intent.extra.FROM";
            public static final String EXTRA_TO                 = "com.enmailing.k9.intent.extra.TO";
            public static final String EXTRA_CC                 = "com.enmailing.k9.intent.extra.CC";
            public static final String EXTRA_BCC                = "com.enmailing.k9.intent.extra.BCC";
            public static final String EXTRA_SUBJECT            = "com.enmailing.k9.intent.extra.SUBJECT";
            public static final String EXTRA_FROM_SELF          = "com.enmailing.k9.intent.extra.FROM_SELF";
        }

        public static class Share {
            /*
             * We don't want to use EmailReceived.EXTRA_FROM ("com.enmailing.k9.intent.extra.FROM")
             * because of different semantics (String array vs. string with comma separated
             * email addresses)
             */
            public static final String EXTRA_FROM               = "com.enmailing.k9.intent.extra.SENDER";
        }
    }
    ...
    public static void save(SharedPreferences.Editor editor) {
		...
		/*editor.putString("enMailingUsername", mEnMailingUsername);
		editor.putString("enMailingAuthKey", mEnMailingAuthKey);
		editor.putString("enMailingDeviceDesc", mEnMailingDeviceDesc);
		editor.putBoolean("enMailingNotifyOnly", mEnMailingNotifyOnly);*/
    ...
    public static void loadPrefs(Preferences prefs) {
        ...
        mEnMailingUsername = sprefs.getString("enMailingUsername", "");
        mEnMailingAuthKey = sprefs.getString("enMailingAuthKey", "");
        mEnMailingDeviceDesc = sprefs.getString("enMailingDeviceDesc", "");
        mEnMailingNotifyOnly = sprefs.getBoolean("enMailingNotifyOnly", false);
    ...
    /*public static String getEnMailingUsername() {
    	return mEnMailingUsername;
    }
    
    public static void setEnMailingUsername(String username) {
    	mEnMailingUsername = username;
    }
    
    public static String getEnMailingAuthKey() {
    	return mEnMailingAuthKey;
    }
    
    public static void setEnMailingAuthKey(String authkey) {
    	mEnMailingAuthKey = authkey;
    }
    
    public static String getEnMailingDeviceDesc() {
    	return mEnMailingDeviceDesc;
    }
    
    public static void setEnMailingDeviceDesc(String devicedesc) {
    	mEnMailingDeviceDesc = devicedesc;
    }
    
    public static boolean getEnMailingNotifyOnly() {
    	return mEnMailingNotifyOnly;
    }
    
    public static void setEnMailingNotifyOnly(boolean notifyOnly) {
    	mEnMailingNotifyOnly = notifyOnly;
    }*/
