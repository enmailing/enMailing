...
package com.enmailing.k9.mail.internet;
...
public class MimeBodyPart extends BodyPart {
    ...
    public void setBody(Body body) throws MessagingException {
        this.mBody = body;
        if (body instanceof com.enmailing.k9.mail.Multipart) {
            com.enmailing.k9.mail.Multipart multipart = ((com.enmailing.k9.mail.Multipart)body);
