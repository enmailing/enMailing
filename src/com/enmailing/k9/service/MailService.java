...
package com.enmailing.k9.service;
...
import com.enmailing.k9.Account.FolderMode;
...
public class MailService extends CoreService {
    private static final String ACTION_CHECK_MAIL = "com.enmailing.k9.intent.action.MAIL_SERVICE_WAKEUP";
    private static final String ACTION_RESET = "com.enmailing.k9.intent.action.MAIL_SERVICE_RESET";
    private static final String ACTION_RESCHEDULE_POLL = "com.enmailing.k9.intent.action.MAIL_SERVICE_RESCHEDULE_POLL";
    private static final String ACTION_CANCEL = "com.enmailing.k9.intent.action.MAIL_SERVICE_CANCEL";
    private static final String ACTION_REFRESH_PUSHERS = "com.enmailing.k9.intent.action.MAIL_SERVICE_REFRESH_PUSHERS";
    private static final String ACTION_RESTART_PUSHERS = "com.enmailing.k9.intent.action.MAIL_SERVICE_RESTART_PUSHERS";
    private static final String CONNECTIVITY_CHANGE = "com.enmailing.k9.intent.action.MAIL_SERVICE_CONNECTIVITY_CHANGE";
    private static final String CANCEL_CONNECTIVITY_NOTICE = "com.enmailing.k9.intent.action.MAIL_SERVICE_CANCEL_CONNECTIVITY_NOTICE";
    ...
    private void cancel() {
        Intent i = new Intent();
        i.setClassName(getApplication().getPackageName(), "com.enmailing.k9.service.MailService");
