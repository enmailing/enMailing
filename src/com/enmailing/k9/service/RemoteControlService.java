...
import com.enmailing.k9.K9.BACKGROUND_OPS;
import com.enmailing.k9.remotecontrol.K9RemoteControl;
import com.enmailing.k9.R;

import static com.enmailing.k9.remotecontrol.K9RemoteControl.*;
...
public class RemoteControlService extends CoreService {
    private final static String RESCHEDULE_ACTION = "com.enmailing.k9.service.RemoteControlService.RESCHEDULE_ACTION";
    private final static String PUSH_RESTART_ACTION = "com.enmailing.k9.service.RemoteControlService.PUSH_RESTART_ACTION";

    private final static String SET_ACTION = "com.enmailing.k9.service.RemoteControlService.SET_ACTION";
            ...
            execute(getApplication(), new Runnable() {
                public void run() {
                    try {
                        ...
                        if (needsReschedule) {
                            Intent i = new Intent();
                            i.setClassName(getApplication().getPackageName(), "com.enmailing.k9.service.RemoteControlService");
