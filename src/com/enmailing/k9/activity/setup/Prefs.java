...
import com.enmailing.k9.activity.ColorPickerDialog;
import com.enmailing.k9.activity.K9PreferenceActivity;
import com.enmailing.k9.controller.MessagingController;
import com.enmailing.k9.helper.FileBrowserHelper;
import com.enmailing.k9.helper.FileBrowserHelper.FileBrowserFailOverCallback;
import com.enmailing.k9.preferences.CheckBoxListPreference;
import com.enmailing.k9.preferences.TimePickerPreference;
...
public class Prefs extends K9PreferenceActivity {
	...
	//private static final String PREFERENCE_ENMAILING_USERNAME = "enmailing_username";
	//private static final String PREFERENCE_ENMAILING_PASSWORD = "enmailing_password";
	//private static final String PREFERENCE_ENMAILING_NOTIFY_ONLY = "enmailing_notify_only";
    ...
    private com.enmailing.k9.preferences.TimePickerPreference mQuietTimeStarts;
    private com.enmailing.k9.preferences.TimePickerPreference mQuietTimeEnds;
    ...
    //private EditTextPreference mEnMailingUsername;
    //private EditTextPreference mEnMailingPassword;
    //private EditTextPreference mEnMailingDeviceDesc;
    /*private TextView mAuthStatus;
    private EditText mEnMailingUsername;
    private EditText mEnMailingPassword;
    ...
    private CheckBoxPreference mEnMailingNotifyOnly;*/
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*mEnMailingUsername = (EditTextPreference) findPreference(PREFERENCE_ENMAILING_USERNAME);
        mEnMailingUsername.setText(K9.getEnMailingUsername());
        
        mEnMailingPassword = (EditTextPreference) findPreference(PREFERENCE_ENMAILING_PASSWORD);
        mEnMailingPassword.setText(K9.getEnMailingPassword());
        
        mEnMailingNotifyOnly = (CheckBoxPreference) findPreference(PREFERENCE_ENMAILING_NOTIFY_ONLY);
        mEnMailingNotifyOnly.setChecked(K9.getEnMailingNotifyOnly());*/
    }
    ...
    private void saveSettings() {
        ...
        /*K9.setEnMailingUsername(mEnMailingUsername.getText());
        K9.setEnMailingPassword(mEnMailingPassword.getText());
        K9.setEnMailingNotifyOnly(mEnMailingNotifyOnly.isChecked());*/
