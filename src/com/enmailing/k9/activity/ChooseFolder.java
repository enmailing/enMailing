...
public class ChooseFolder extends K9ListActivity {
    public static final String EXTRA_ACCOUNT = "com.enmailing.k9.ChooseFolder_account";
    public static final String EXTRA_CUR_FOLDER = "com.enmailing.k9.ChooseFolder_curfolder";
    public static final String EXTRA_SEL_FOLDER = "com.enmailing.k9.ChooseFolder_selfolder";
    public static final String EXTRA_NEW_FOLDER = "com.enmailing.k9.ChooseFolder_newfolder";
    public static final String EXTRA_MESSAGE = "com.enmailing.k9.ChooseFolder_message";
    public static final String EXTRA_SHOW_CURRENT = "com.enmailing.k9.ChooseFolder_showcurrent";
    public static final String EXTRA_SHOW_FOLDER_NONE = "com.enmailing.k9.ChooseFolder_showOptionNone";
    public static final String EXTRA_SHOW_DISPLAYABLE_ONLY = "com.enmailing.k9.ChooseFolder_showDisplayableOnly";
